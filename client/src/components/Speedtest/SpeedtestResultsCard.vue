  ...
  <v-card v-if="results" color="secondary darken-3 pa-0 ma-0" rounded="10">
    <div class="pa-4">
      <div class="d-flex flex-wrap align-start justify-center">
        <div
          class="mx-2 d-flex order-first flex-column align-start secondary darken-2 pa-2 ma-3 rounded-lg"
        >
        ...
        <div
          class="mx-4 d-flex order-last flex-column align-center secondary darken-2 pa-2 ma-3 rounded-lg mb-2"
        >
        ...
        <div
          class="mx-2 d-flex flex-column align-start secondary darken-2 pa-2 ma-3 rounded-lg"
        >
      ...
      <div
        class="d-flex align-start justify-space-around pa-1 secondary darken-2 ma-2 rounded-lg"
      >
