  ...
  <v-card v-if="results" color="secondary darken-3 pa-0 ma-0" rounded="10">
    <div class="pa-4">
      <div class="d-flex flex-wrap align-start justify-center">
        <div class="mx-2 d-flex order-first flex-column align-start secondary darken-2 pa-2 ma-3 rounded-lg">
          <div class="text-h5">Download</div>
          <div class="text-h1 font-weight-bold">
            {{ downloadSpeed | convertToMegabits }}<span class="text-h4 mx-4">Mbps</span>
          </div>
        </div>

        <div class="mx-4 d-flex order-last flex-column align-center secondary darken-2 pa-2 ma-3 rounded-lg mb-2">
          <div class="d-flex align-center justify-center">
            <div class="d-flex align-baseline justify-start">
              <div class="font-weight-bold text-subTitle mx-2 align-baseline">Host:</div>
          ...
          <div class="d-flex align-center justify-center mt-3">
            <div class="d-flex align-center justify-center">
              <div class="font-weight-bold text-heading mx-2">Ping</div>
              <div class="font-weight-bold text-h4 mx-2">
                {{ latency }}
              </div>
            </div>
          </div>
        ...
        <div class="mx-2 d-flex flex-column align-start secondary darken-2 pa-2 ma-3 rounded-lg">
          <div class="text-h5">Upload</div>
          <div class="text-h1 font-weight-bold">
            {{ uploadSpeed | convertToMegabits }}<span class="text-h4 mx-4">Mbps</span>
          </div>
        </div>
      </div>

      <div class="d-flex align-start justify-space-around pa-1 secondary darken-2 ma-2 rounded-lg">
